    ...
    HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam, LRESULT* result)
{
    if (message == WM_COMMAND)
    {
        ...
        case ID_CLEAR_SERVER_CERTIFICATE_ERROR_ACTIONS:
        {
            ...
            // certificate errors.
            CHECK_FAILURE(m_webView2_13->ClearServerCertificateErrorActions(
...
void SettingsComponent::ToggleCustomServerCertificateSupport()
{
    if (m_webView2_13)
    {
        ...
        {
            CHECK_FAILURE(m_webView2_13->add_ServerCertificateErrorDetected(
        ...
        {
            CHECK_FAILURE(m_webView2_13->remove_ServerCertificateErrorDetected(
                m_ServerCertificateErrorToken));
