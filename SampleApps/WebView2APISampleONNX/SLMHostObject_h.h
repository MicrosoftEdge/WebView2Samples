...
EXTERN_C const IID IID_ISLMHostObject;
    ...
    MIDL_INTERFACE("C7D6D547-5E37-4D1A-9B53-2B4C8F1A0001")
...
#define ISLMHostObject_InferAsync(This,message,tokenCallback,completionCallback)	\
    ( (This)->lpVtbl -> InferAsync(This,message,tokenCallback,completionCallback) ) 
...
class DECLSPEC_UUID("C7D6D547-5E37-4D1A-9B53-2B4C8F1A0003")
SLMHostObject;
#endif
